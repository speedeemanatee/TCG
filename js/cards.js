...
const Hitmonlee = {
    ...
    hp: 80,
    evolvesFrom: null,
    image: 'assets/pokemon/hitmonlee.png',
    placeholderIcon: '🦵',
    weakness: PokemonType.PSYCHIC,
    resistance: null,
    retreatCost: 2,
...
const Hitmonchan = {
    ...
    hp: 80,
    evolvesFrom: null,
    image: 'assets/pokemon/hitmonchan.png',
    placeholderIcon: '🥊',
    weakness: PokemonType.PSYCHIC,
    resistance: null,
    retreatCost: 2,
...
const Potion = {
    ...
    image: 'assets/pokemon/potion.png',
    placeholderIcon: '🧪',
    effect: 'heal',
    healAmount: 30,
...
const Switch = {
    ...
    cardType: CardType.TRAINER,
    trainerType: TrainerType.ITEM,
    image: 'assets/pokemon/switch.png',
    placeholderIcon: '🔄',
    effect: 'switch',
...
const ProfessorsResearch = {
    ...
    image: 'assets/pokemon/professors_research.png',
    placeholderIcon: '🎓',
...
const PokeBall = {
    ...
    cardType: CardType.TRAINER,
    trainerType: TrainerType.ITEM,
    image: 'assets/pokemon/poke_ball.png',
    placeholderIcon: '🔴',
...
const EnergyRetrieval = {
    ...
    cardType: CardType.TRAINER,
    trainerType: TrainerType.ITEM,
    image: 'assets/pokemon/energy_retrieval.png',
    placeholderIcon: '🔋',
...
const SuperPotion = {
    ...
    cardType: CardType.TRAINER,
    trainerType: TrainerType.ITEM,
    image: 'assets/pokemon/super_potion.png',
    placeholderIcon: '🧪',
    effect: 'superHeal',
    healAmount: 60,
    discardEnergy: 1,
...
const Marnie = {
    ...
    cardType: CardType.TRAINER,
    trainerType: TrainerType.SUPPORTER,
    image: 'assets/pokemon/marnie.png',
    placeholderIcon: '🙆‍♀️',
...
const BossOrders = {
    ...
    cardType: CardType.TRAINER,
    trainerType: TrainerType.SUPPORTER,
    image: 'assets/pokemon/boss_orders.png',
    placeholderIcon: '🤵',
    effect: 'gust',
